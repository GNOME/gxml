	...
	public static void add_tests () {
		...
		Test.add_func ("/gxml/t-document/namespace", () => {
				try {
					...
					assert (doc.namespaces[0].prefix == "gxml");
					(c as Element).set_ns_attr (doc.namespaces[0].prefix+":"+doc.namespaces[0].uri, "prop", "Ten");
		...
		Test.add_func ("/gxml/t-document/read/basic", () => {
			try {
				...
				assert (a1.children_nodes[1].children_nodes[0].value == "fweasley@hogwarts.co.uk");
				...
				assert (a2.children_nodes[2].children_nodes[0].value == "gweasley@hogwarts.co.uk");
		...
		Test.add_func ("/gxml/t-document/read/pi", () => {
			try {
				...
				assert ((d.children_nodes[1] as GXml.ProcessingInstruction).target == "target");
